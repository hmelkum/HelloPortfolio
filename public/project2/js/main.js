...
//------------------- BEGIN YOUR CODE
	...
	var newX = -gravityConst/r2*obj.pos.x;
	var newY = -gravityConst/r2*obj.pos.y;	
	var newZ = -gravityConst/r2*obj.pos.z;
...
function getPosition(obj) {
 ...
 //  	obj.a=a;
	...
	//if(obj.pos.y<=0) {v.y= v.y -a.y; v.y *=-1}
	//if(oobj.pos.z<=0) {v.z= v.z -a.y; v.z *=-1}
